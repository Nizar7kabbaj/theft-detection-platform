...
const NAV_CLASS = "flex flex-1 flex-col gap-3 overflow-y-auto px-2 py-3"

const SECTION_CLASS = "flex flex-col gap-0.5"

const HEADING_CLASS = "px-2 text-[0.6875rem]/4 text-muted-foreground/80 uppercase tracking-wider"

const LINK_BASE_CLASS =
  "relative flex items-center gap-3 rounded-md px-2 py-1.5 font-medium text-[0.8125rem]/5 outline-none transition-colors focus-visible:ring-2 focus-visible:ring-sidebar-ring"
